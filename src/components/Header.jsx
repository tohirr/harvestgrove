...
export const Header = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto relative min-h-[80vh]">
        <header className="w-full lg:p-4 p-2 flex items-center justify-between">
      ...
      <div className="relative ">
        ...
        <h2 className="relative lg:leading-[5rem] text-2xl md:p-3 p-2 lg:text-6xl capitalize">nurturing nature, <br/> harvesting excelence</h2>
